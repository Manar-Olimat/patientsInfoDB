<!-- Create a small web application to manage the Patient info, 
this application should contain 4 pages 
[View Patient, Add Patient, Update Patient, Remove Patient] -->
...
class GetInfo extends DbConnect{
    public function select($id_condition){
...
public function getUsrs(){
    ...
    while ($row=$stmt->fetch()) {?>
        ...
        <div class="card">
        <div class="img">
            <?php echo '<img src="' . $this->randomImg(). '" alt="avatar">' ;?>
...
<input type="text" id="id-hidden"  name="id-hidden"
  ...
  name="more-info">More info</button>
        ...
        <?php 
         $currentId=$row['id'];
         echo $currentId;
            // $currentId=$_REQUEST['id-hidden'];
//    $viewAll= new GetInfo(); 
$row1= $this->select($currentId);
print_r($row1);
        ?>
        <!-- Modal -->
...
<span class="input-wrapper">
  ...
  name="patientName" value="<?php echo $row1['Name'] ;?>" type="text">
</span>
...
<span class="input-wrapper">
  <input class="input" disabled id="patientAge"
   name="patientAge" value="<?php echo $row1['Age'] ;?>" type="text">
</span>
...
<span class="input-wrapper">
  <input class="input" disabled id="patientAddress"
   name="patientAddress" value="<?php echo $row1['Address']; ?>" type="text">
</span>
...
<span class="input-wrapper">
  <input class="input" disabled id="patientDisease"
   name="patientDisease" value="<?php echo $row1['Disease'] ;?>" type="text">
</span>

</label><br> 
      </div>
      <div class="modal-footer">
      <form  method="get">    <button class="edit-record">
      <input type="text" name="id" class="id-hidden" value="<?php echo $row1['id'];?>">
...
<button class="delete-record" name="delete-record " type="button">
 <svg xmlns="http://www.w3.org/2000/svg" width="24" fill="#ffffff" height="24" viewBox="0 0 24 24"><path d="M24 20.188l-8.315-8.209 8.2-8.282-3.697-3.697-8.212 8.318-8.31-8.203-3.666 3.666 8.321 8.24-8.206 8.313 3.666 3.666 8.237-8.318 8.285 8.203z"></path></svg>
  ...
  <?php 
  if (isset($_REQUEST['delete-record']))
  {
    $this->deleteRecord(1);
  }
  ?>
...
<!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
  <path fill="#5000ca" fill-opacity="1" d="M0,64L34.3,101.3C68.6,139,137,213,206,250.7C274.3,288,343,288,411,288C480,288,549,288,617,282.7C685.7,277,754,267,823,250.7C891.4,235,960,213,1029,197.3C1097.1,181,1166,171,1234,186.7C1302.9,203,1371,245,1406,266.7L1440,288L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path>
</svg> -->
...
//     $currentId=$_REQUEST['id-hidden'];
//    $viewAll= new GetInfo(); 
// $row= $viewAll->select($currentId);
// print_r($row);
?>

<?php
if(isset($_REQUEST['more-info'])){
