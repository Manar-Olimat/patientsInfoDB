...
<?php
 ...
 function setUsrs($name,$age,$address,$disease){
$id=randomId();
echo $conn;
...
<!-- // back to home bage -->
<form method="post"> 
<button class="cta" href="./index.php" name="home">
...
<?php
// set new patient on submit
if(isset($_POST['submit']))
{
$name=$_REQUEST['patientName'];
$age=$_REQUEST['patientAge'];
$address=$_REQUEST['patientAddress'];
$disease=$_REQUEST['disease'];
try{
   setUsrs($name,$age,$address,$disease);
echo 'deno';}
catch(Exeption $e){
    echo $e->getMessage();
}
...
<span class="input-wrapper">
  <input class="input" id="patientName" name="patientName" placeholder="Type here..." type="text">
</span>
...
<label class =" label" for="patientAge">
    Patient Age: 
<span class="input-wrapper">
  <input class="input" id="patientAge" name="patientAge" placeholder="Type here..." type="text">
</span>
...
<label class =" label" for="patientAddress">
    Patient Address: 
<span class="input-wrapper">
  <input class="input" id="patientAddress" name="patientAddress" placeholder="Type here..." type="text">
</span>
...
<button type="submit" name="submit" id="submit-ptn"> Add Patient
</button>
</form>
